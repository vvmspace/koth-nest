...
export class AlterUsersIdsToString1718781431403 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "telegramReferrerId" TYPE character varying USING "telegramReferrerId"::character varying`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "telegramReferrerId" TYPE bigint USING "telegramReferrerId"::bigint`);
